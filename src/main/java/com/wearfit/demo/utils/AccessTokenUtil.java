...
public class AccessTokenUtil {
	...
	public static String getTokenStr() {
		return queryAccessToken().getAccess_token() == null ? DeviceApi.getAccessToken().getAccess_token() : queryAccessToken().getAccess_token() ;
	}
	...
	private static void refreshToken() {
		try {
			...
			AccessToken accessToken = DeviceApi.getAccessToken();
